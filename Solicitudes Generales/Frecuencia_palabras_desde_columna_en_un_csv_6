...
palabras_a_quitar = set([
    ...
    'tardes', 'debido', 'cual', 'muchas', 'estoy'
])
...
input_file = 'solicitudes-generales-20240525150546.csv'  # Nombre del archivo CSV de entrada
text_columns = ['Asunto', 'Descripcion']  # Nombres de las columnas que contienen el texto
